...
const {cloneNode, insertBefore} = globalThis.Node.prototype;
...
const renderHTML = (target, data, start = 0, end=null) => {
	...
	const insertRow = insertBefore.bind(target);
...
//	let fragment = globalThis.document.createDocumentFragment()
	for (let i = start; i<stop; ++i) {
		...
		insertRow(cloned, null)
		// Append fragment every batchSize nodes or at the end
		// if ((i - start + 1) % 500 === 0 || i === stop - 1) {
		// 	target.append(fragment)
		// 	fragment = globalThis.document.createDocumentFragment()
		// }
